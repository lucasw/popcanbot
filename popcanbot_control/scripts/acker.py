    ...
    def __init__(self):
        ...
        self.joints = rospy.get_param("~steered_joints",
                                       [{'link': 'front_left_steer',
                                         ...
                                         'steer_topic': '/popcanbot/front_left/steer_position_controller/command',
                                         'wheel_joint': 'wheel_front_left_axle',
                                         'wheel_topic': '/popcanbot/front_left/wheel_position_controller/command'},
                                        {'link': 'front_right_steer',
                                         'steer_joint': 'front_right_steer_joint',
                                         'steer_topic': '/popcanbot/front_right/steer_position_controller/command',
                                         'wheel_joint': 'wheel_front_right_axle',
                                         'wheel_topic': '/popcanbot/front_right/wheel_position_controller/command'},
                                        {'link': 'back_left',
                                         'steer_joint': None,
                                         'steer_topic': None,
                                         'wheel_joint': 'wheel_back_left_axle',
                                         'wheel_topic': '/popcanbot/back_left/wheel_position_controller/command'},
                                        {'link': 'back_right',
                                         'steer_joint': None,
                                         'steer_topic': None,
                                         'wheel_joint': 'wheel_back_right_axle',
                                         'wheel_topic': '/popcanbot/back_right/wheel_position_controller/command'}])
